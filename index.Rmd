...
map = leaflet(width="100%") %>% 
    ...
    addCircleMarkers(lng=-84.555, lat=42.732, color='#0000ee', radius=5, label='Lansing', popup='Capital of Michigan') %>%
    addCircleMarkers(lng=-83.045, lat=42.331, color='#00ee00', fill=FALSE, radius=3, weight=1, opacity=1, label='Detroit') %>%
